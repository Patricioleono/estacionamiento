    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav justify-content-end">
                ...
                <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url("index.php/vehiculo/index") ?>">Mantenedor Vehiculos</a>
                </li>
                <? } ?>
                <? } ?>
                <li class="nav-item">
...
<body>
<div id="container">
	<h1><i class="fas fa-car-side"></i> Mantenedor de Vehiculos</h1>
    <div class="form-group p-2">
    <? if ($permiso > 1) { ?>
    <div id="liveAlertPlaceholder"></div>
            <div class="col-12 p-2">
                <table id="tablaV" class="table" style="width:100%">
                    <thead>
                    <tr>
                        <th scope="col">RUT</th>
