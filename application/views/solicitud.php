...
<head>
	<meta charset="utf-8">
	<title>Estacionamiento - Solicitudes</title>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav justify-content-end">
                ...
                <? if ($permiso > 0) { ?>
                <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url("index.php/solicitud/index") ?>">Mantenedor Solicitudes</a>
                </li>
                <? if ($permiso > 1) { ?>
                <li class="nav-item">
...
<div id="container">
	<h1><i class="fas fa-file"></i> Mantenedor de Solicitudes</h1>
    ...
    <? if ($permiso > 0) { ?>
		...
		<div class="row p-2">
            ...
            <div class="col-10 p-2">
                <button class="btn btn-primary" id="botonModalSolicitud" data-bs-toggle="modal" data-bs-target="#modalS"><i class="far fa-file"></i> Añadir Solicitud</button>
            </div>
            <div class="col-2 p-2">
                <div class="row">
                    <div class="col-4 p-2">
                        <p class="label" style="color:black;"><i class="fas fa-car"></i> <span class="badge text-wrap align-top" id="recargarAuto" style="color:black;border: 2px solid #337ab7;"><?php echo $parametrosA - $autoA ?></span></p>
                    </div>
                    <div class="col-4 p-2">
                        <p class="label" style="color:black;"><i class="fas fa-motorcycle"></i> <span class="badge text-wrap align-top" id="recargarMoto" style="color:black;border: 2px solid #337ab7;"><?php echo $parametrosM - $motoA ?></span></p>
                    </div>
                    <div class="col-4 p-2">
                        <p class="label" style="color:black;"><i class="fas fa-bicycle"></i> <span class="badge text-wrap align-top" id="recargarBici" style="color:black;border: 2px solid #337ab7;"><?php echo $parametrosB - $biciA ?></span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 p-2">
            <table id="tablaPersona" class="table" style="width:100%">
                <thead>
                <tr>
                    <th scope="col">RUT</th>
        ...
        <? } else if($permiso == 1) { ?>
        <div class="col-12 p-2">
            <table id="tablaMantenedor" class="table" style="width:100%">
                <thead>
                <tr>
                    <th scope="col">RUT</th>
                    <th scope="col">TIPO</th>
